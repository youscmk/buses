...
echo 
  ...
  $hoy = date("Y-m-d h:i:s ");
   ...
   $sql = "INSERT INTO telco (cuenta,id_tracker,`plate`,`imei`,`telefono`,`telco` ) VALUES ('ssvq','$id','$plate','$imei','$phone','$telco'  )";
    ...
    // LO actualizo conforme a la echa de hoy y tambien a la patente me falta terminar el update
      ...
      $sql1 = "UPDATE telco SET `cuenta`='ssvq',`plate`='$plate',`imei`='$imei' ,`telefono`='$phone',`telco`='$telco'  WHERE `id_tracker`='$id' ";
