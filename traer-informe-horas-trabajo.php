...
foreach ($buses as $items) {
  ...
  $datosduplicados = mysqli_query($mysqli, "SELECT * FROM reporte_ralenti WHERE total_horas='$total_horas' AND ralenti='$ralenti' AND en_movimiento='$en_movimiento' AND fecha_ayer='$fecha_ayer'");
