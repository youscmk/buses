...
foreach ($buses as $items) {
  ...
  $sql = "INSERT INTO reporte_ralenti (patente, patenteId, total_horas, ralenti, en_movimiento, fecha) VALUES ('$plate','$VarId', '$total_horas', '$ralenti', '$en_movimiento', '$fecha_ayer')";
